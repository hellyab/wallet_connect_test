...
import 'package:wallet_connect_test/eth_conversions.dart';
import 'package:wallet_connect_test/qr_scan_view.dart';
...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Scaffold(
      ...
      body: InAppWebView(
        initialUrlRequest: URLRequest(
          url: Uri.parse('https://wallet-connect-affable.netlify.app/'),
        ),
  ...
  _qrScanHandler(String value) {
    ...
    final peerMeta = WCPeerMeta(
      name: "Example Wallet",
      url: "https://wallet-connect-affable.netlify.app/",
